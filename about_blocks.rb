...
class AboutBlocks < Neo::Koan
  ...
  def test_blocks_can_be_assigned_to_variables_and_called_explicitly
    # lambda seems to be blocks with a variable name
    # need to send the .call message to trigger the block that is assigned to the lamda
  ...
  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    ...
    # the  & in front seems to expose the block part of the lamda
  ...
  # explicit means a block argument is required for the method to not throw an error
