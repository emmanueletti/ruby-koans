...
class AboutArrays < Neo::Koan
  ...
  def test_arrays_and_ranges
    ...
    assert_equal [1, 2, 3, 4, 5], (1..5).to_a # 1 to 5, including 5
    assert_equal [1, 2, 3, 4], (1...5).to_a # 1 to number just before 5
  end
  ...
  def test_slicing_with_ranges
    ...
    assert_equal %i[peanut butter], array[0...2] #same effect as array[0, 2]
