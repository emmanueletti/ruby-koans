...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  #  they return the longest possible match they can return
  # if there are muliple matches for the pattern, they return the one that is longest
  ...
  def test_the_left_most_match_wins
    ...
    # WHY?????
    # i thought it would return the longest possible match -> "az"
  end
  ...
  def test_slash_s_is_a_shortcut_for_a_whitespace_character_class
    assert_equal " \t\n", "space: \t\n"[/\s+/]
    # \t is whitespace new tab, \n is white space new line
  end
  ...
  def test_sub_is_like_find_and_replace
    ...
    #  remember regexp apparently will match and return the left most one
  end
